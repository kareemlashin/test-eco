...
404===b.status&&"error"===c?a.html(''):a.html('')}})}else a.addClass("livicon-evo-error").html('')})},
...
typeof b.afterUpdate&&b.afterUpdate()},error:function(b,c){a.addClass("livicon-evo-error");0===b.status&&"error"===c?a.html():
a.html();
